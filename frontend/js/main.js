        ...
        if (!infoData.success) {
            resultsDiv.innerHTML = `
                <div class='alert alert-danger'>
                    ...
                    <p>${infoData.error || 'No se pudo obtener información del artículo'}</p>
                </div>`;
            return;
        }
        
        // Guardar la información del artículo
        currentPaperInfo = infoData.info;
        selectedSourceIndex = 0; // Por defecto, seleccionar la primera fuente
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <button id="downloadBtn" class="btn btn-success" onclick="descargarArticulo('${doi}')">
...
window.descargarArticulo = function(doi) {
